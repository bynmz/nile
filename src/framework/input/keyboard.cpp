...
void KeyboardMovementController::moveInPlaneXYZ(
    GLFWwindow* window, float dt, NileGameObject& gameObject) {
  glm::vec3 rotate{0};
...
void KeyboardMovementController::moveInPlaneXY(
    GLFWwindow* window, float dt, NileGameObject& gameObject) {

    const glm::vec2 rightDir{1.f, 0.f};
    const glm::vec2 upDir{0.f, -1.f};
